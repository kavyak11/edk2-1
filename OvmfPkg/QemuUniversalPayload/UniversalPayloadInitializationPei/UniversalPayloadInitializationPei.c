  ...
  )
{
  ...
  SetUplUint64 (UPL_KEY_SERIAL_PORT_BAUDRATE, (UINT64)PcdGet32 (PcdSerialBaudRate));
  SetUplBoolean (UPL_KEY_SERIAL_PORT_USE_MMIO, PcdGetBool (PcdSerialUseMmio));
  SetUplUint64 (UPL_KEY_SERIAL_PORT_REGISTER_BASE, (UINT64)PcdGet64 (PcdSerialRegisterBase));
  SetUplUint64 (UPL_KEY_SERIAL_PORT_REGISTER_STRIDE, (UINT64)PcdGet32 (PcdSerialRegisterStride));
