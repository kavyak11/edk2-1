  ...
  )
{
  ...
  Serial->PldHeader.Revision = 1;
  Serial->PldHeader.Length = sizeof (PLD_SERIAL_PORT_INFO);
  ...
  PciRootBridgeInfo->PldHeader.Length = sizeof (PciRootBridgeInfo) + sizeof (PLD_PCI_ROOT_BRIDGE);
  PciRootBridgeInfo->PldHeader.Revision = 1;
